...
df_grouped <- df_night %>%
  ...
  filter(duration >= 30)  # Nur Intervalle mit einer Dauer von >= 30 Minuten beibehalten
```
...
Die folgende Grafik zeigt die Ergebnisse der Einzelnächte-Analyse für den Monat Dezember, einschliesslich der MSAS-Werte, der Temperaturbereiche unter 0°C und der astronomischen Nachtzeiten.
